...
def About(request):
    return HttpResponse('this is about sesion')
...
def updatereview(request, review_id):
    ...
    if request.method =='GET':
        ...
        try:
            ...
            return render(request, 'updatereview.html',{'review': review, 'form': form, 'error': 'Bad data inform'})
